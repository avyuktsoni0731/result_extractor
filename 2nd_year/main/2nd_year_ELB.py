...
with open('../branch_wise_list/electronics.csv', 'r') as input_file:
    ...
    for j in list_main:
        ...
        try:
            ...
            with open ('../branch_wise_result/2nd_year_ELB_result.csv', 'a+') as output_file:
                ...
                if(XPATH_FAC_NO[fac_no_slice] == 'ELB'):
                    list_ELB.append('Electronics')
    ...
    dict_ELB = {'Faculty No': list_fac_no, 'Enrol. No': list_enr_no, 'Name': list_name, 'Branch': list_ELB, 'ODD_SPI': list_odd_spi, 'CPI': list_cpi}
