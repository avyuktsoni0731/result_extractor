...
with open('../branch_wise_list/food_tech.csv', 'r') as input_file:
    ...
    for j in list_main:
        ...
        try:
            ...
            with open ('../branch_wise_result/2nd_year_FTB_result.csv', 'a+') as output_file:
                ...
                if(XPATH_FAC_NO[fac_no_slice] == 'FTB'):
                    list_FTB.append('Food Technology')
    ...
    dict_FTB = {'Faculty No': list_fac_no, 'Enrol. No': list_enr_no, 'Name': list_name, 'Branch': list_FTB, 'ODD_SPI': list_odd_spi, 'CPI': list_cpi}
