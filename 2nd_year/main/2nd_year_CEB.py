...
with open('../branch_wise_list/civil.csv', 'r') as input_file:
    ...
    for j in list_main:
        ...
        try:
            ...
            with open ('../branch_wise_result/2nd_year_CEB_result.csv', 'a+') as output_file:
                ...
                if(XPATH_FAC_NO[fac_no_slice] == 'CEB'):
                    list_CEB.append('Civil')
    ...
    dict_CEB = {'Faculty No': list_fac_no, 'Enrol. No': list_enr_no, 'Name': list_name, 'Branch': list_CEB, 'ODD_SPI': list_odd_spi, 'CPI': list_cpi}
